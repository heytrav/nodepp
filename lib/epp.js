...
module.exports = function(registry, config) {
    return {
        ...
        "createContact": function(data, transactionId){
            ...
            var createContact = {
                "contact:create": {
                    "_attr": {"xmlns:contact": contactNamespace.contact},
                    "contact:id": data.id,
                    "contact:postalInfo": postalInfo,
                    "contact:voice": postalInfo.voice,
                    "contact:fax": postalInfo.fax,
                    "contact:email": postalInfo.email,
                    "contact:authInfo": {"contact:pw": data.authInfo.pw},
                    "contact:disclose": disclosing
                }
            };
            var xml = this.eppCommand({

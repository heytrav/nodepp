...
module.exports = function EPP(registry, config) {
    return {
        "hello": function() {
            return this.eppWrapper({
                "hello": null
        ...
        "processStatus": function(objStatus) {
        ...
        "processStatusSet": function(statusSet) {
            var stati = [];
        ...
        "deleteContact": function(data, transactionId) {
            var contactNamespace = config.namespaces.contact;
            var deleteData = {
                "contact:delete": {
                    "_attr": {

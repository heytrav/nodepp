...
EPP.prototype.logout = function(transactionId) {
...
EPP.prototype.createDomain = function(data, transactionId) {
    ...
    var processExtension = this.createDomainSecDnsExtension;
    if (data.extension && processExtension instanceof Function) {
        commandData.extension = this.createDomainSecDnsExtension(data.extension, commandData);
    }

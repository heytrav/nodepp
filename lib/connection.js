            ...
            try {
                ...
                newStream.on('readable', function() {
                    ...
                    if (streamBufferLength > 4) {
                        console.log("Got string: ", streamBuffer.toString());
                        self.clientResponse(streamBuffer);
                    } else {
                    ...
                    //console.log("raw buffer: ", streamBuffer);
                    ...
                    //if (streamBuffer.length > 4) {
                        ...
                        //var xml = streamBuffer.slice(startIndex, null );

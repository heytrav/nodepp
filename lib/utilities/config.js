...
var getSecret require('./docker-secrets').getSecret;
...
module.exports.getConfig = function(file = "epp-config.json") {
  ...
  getSecret('EPP_LOGIN_FILE', (line) => { config.set('epp_login', line); })
  getSecret('EPP_PASSWORD_FILE', (line) => { config.set('epp_password', line); })
  return nconf;
};

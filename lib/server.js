...
program.version('0.0.1').option('-r, --registries', 'Registry', collectRegistries, [])
.option('-l, --listen', 'Listen on port', parseInt, 3000).parse(process.argv);

console.log("Passed regsitries: ", program.registries);

        ...
        "command": function(command, data, callback) {
            ...
            try {
                ...
                case 'createDomain':
                    ...
                    break;
                case 'infoDomain':
                    this.infoDomain(data, returnCallback);
                    break;
                case 'deleteDomain':
                    this.deleteDomain(data, returnCallback);
                    break;
                case 'checkHost':
                    this.checkHost(data, returnCallback);
                    break;
                case 'createHost':
                    this.createHost(data, returnCallback);
                    break;
                case 'infoHost':
                    this.infoHost(data, returnCallback);
                    break;
                case 'deleteHost':
                    this.deleteHost(data, returnCallback);
                    break;
                case 'checkContact':
                    this.infoContact(data, returnCallback);
                    break;
                case 'infoContact':
                    this.infoContact(data, returnCallback);
                    break;
                case 'createContact':
                    ...
                    break;
                case 'deleteContact':
                    this.deleteContact(data, returnCallback);
                    break;
                default:

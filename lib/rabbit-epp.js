...
program.version('0.0.1').usage('[options]').option('-r, --registries <registry>', 'Registry', collectRegistries, []).option('-q, --amqphost', 'Rabbit Host');
...
console.log("Connecting to AMQP server at: ",rabbitmqConfig.connection);
